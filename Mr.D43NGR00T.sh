...
echo -b "TYPE      : TOOLS INSTALLER $blue " |lolcat
echo -b "VERSION   : V.3 " | lolcat
echo -b "TOTALS    : 311 TOOLS " | lolcat
echo -b "AUTHOR    : Mr.D43NGR00T $blue " |lolcat
echo -b "ASSOCIATE : Daeng soCiety Team $blue " |lolcat
echo -b "ASSOCIATE : Daeng soCiety Team [+]Termux Tutorial $blue " |lolcat
echo -b "ASSOCIATE : Daeng SoCiety Team Berkarya $blue " |lolcat
...
ctrl_c() {
clear
echo -b $blue"[#]> TOOLS YANG KALIAN INSTALL ADA DI DIRECTORY TOOLS GUA " |lolcat
echo -b $blue"[#]> Thanks For Using My Tools" |lolcat
sleep 1
echo -b $blue"[#]> Mr.D43NGR00T" |lolcat

echo -b $blue"[#]> See you Again SCRIPTKIDDIES😎 :)..." |lolcat
figlet Mr.D43NGR00T | lolcat
sleep 1
exit
}
...
00) echo "AUTHOR: Mr.D43NGR00T" | lolcat
echo "Mr.D43NGR00T ON YOUR SYSTEM" | lolcat
echo "Daeng sooCiety Team" | lolcat
